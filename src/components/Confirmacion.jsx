...
export default function Confirmacion({ onConfirmar }) {
  return (
    <section className="py-2 px-6 flex justify-center">
      
      <div
        className="relative max-w-md w-full rounded-3xl shadow-xl border border-[#E8E2D9] p-10 text-center overflow-hidden"
      >
        ...
        <button
          onClick={onConfirmar}
          className="bg-gradient-to-b from-[#E4C77F] to-[#B79240] text-white font-semibold font-[Poppins] px-7 py-3 rounded-full shadow-md active:scale-95 transition-all"
        >
          CONFIRMAR
        </button>
